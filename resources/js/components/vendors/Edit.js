...
function Edit(props) {
    ...
    const [state, setState] = useState({
        ...
        company_name: props.location.state.company_name ? props.location.state.company_name : '',
...
const handleFileChange = (e) => {
    ...
    const onSubmitHandle = (e) =>{
        ...
        if (simpleValidator.current.allValid()) {
            ...
            axios.post('/api/v1/vendors/update', formData,{
                params: {
                                    ...
                                    <form className="edit-lead-form border" onSubmit={onSubmitHandle}>
                                        ...
                                        <div className="form-group">
                                            <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                                <li className="nav-item">
                                                    <span className="nav-link btn btn-gradient-primary btn-block active">EDIT VENDOR</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="form-group">
                                     ...
                                     {/* account_number */}
                                        ...
                                        <div className="form-group text-center">
                                            ...
                                            <Link to='/vendors' className="btn btn-inverse-secondary btn-md">Cancel</Link>
                                        </div>
                                    </form>
                                </LoadingOverlay>
                            </div>
