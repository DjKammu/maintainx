...
function Edit(props) {
    ...
    const [state, setState] = useState({
        ...
        permissions: props.location.state.lead.permissions ? props.location.state.lead.permissions : '',
        loading: false,
    ...
    const onSubmitHandle = (e) =>{
        ...
        if (simpleValidator.current.allValid()) {
            ...
            axios.post('/api/v1/roles/update', $(e.target).serialize())
            .then(response => {
                setState({
                    ...state,
                    loading: false
                    ...
                    <div className="card-body">
                                        ...
                                        <div className="form-group">
                                            <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                                <li className="nav-item">
                                                    <span className="nav-link btn btn-gradient-primary btn-block active">EDIT ROLE</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="form-group">
                        ...
                        <span className="mr-1">View</span>
                           ...
                           <input type="checkbox" id="view"  
                               ...
                               defaultChecked={state.permissions.includes('view')}
                              />
                      ...
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="add">
                        ...
                        <input type="checkbox" id="add"  
                           value="add"
                           onChange={handleCheckboxChange}
                           defaultChecked={state.permissions.includes('add')}
                          />
                      </label>
                      ...
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="edit">
                        ...
                        <input type="checkbox" id="edit"  
                           value="edit"
                           onChange={handleCheckboxChange}
                           defaultChecked={state.permissions.includes('edit')}
                          />
                      </label>
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="update">
                        ...
                        <input type="checkbox" id="update"  
                           value="update"
                           onChange={handleCheckboxChange}
                           defaultChecked={state.permissions.includes('update')}
                          />
                      </label> 
                      ...
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="delete">
                        ...
                        <input type="checkbox" id="delete"  
                           value="delete"
                           onChange={handleCheckboxChange}
                           defaultChecked={state.permissions.includes('delete')}
                          />
                      </label>
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="add_users">
                        ...
                        <input type="checkbox" id="add_users"  
                           value="add_users"
                           onChange={handleCheckboxChange}
                           defaultChecked={state.permissions.includes('add_users')}
                          />
                      </label>
                             </div>
                             </div>
