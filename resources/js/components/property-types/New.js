...
function New(props) {
    ...
    useEffect(() => {
        document.title = 'New Property Type';
    ...
    const onSubmitHandle = (e) =>{
        ...
        if (simpleValidator.current.allValid()) {
            ...
            axios.post(
              '/api/v1/property-types',formData,{
              params: {
                ...
                <div className="card-body">
                    <div className="row new-lead-wrapper d-flex justify-content-center">
                                    ...
                                    <div className="form-group">
                                        <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                            <li className="nav-item">
                                                <span className="nav-link btn btn-gradient-primary btn-block active">NEW PROPERTY TYPE</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="form-group">
                       ...
                       <div className="form-group text-center">
                            ...
                            <Link to='/property-types' className="btn btn-inverse-secondary btn-md">Cancel</Link>
                        </div>
                                </form>
                            </LoadingOverlay>
                        </div>
