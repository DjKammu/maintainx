...
function Edit(props) {
    ...
    useEffect(() => {
        document.title = 'Edit Contractor';
...
const handleFileChange = (e) => {
    ...
    const onSubmitHandle = (e) =>{
        ...
        if (simpleValidator.current.allValid()) {
            ...
            axios.post('/api/v1/contractors/update', formData,{
                params: {
                                        ...
                                        <div className="form-group">
                                            <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                                <li className="nav-item">
                                                    <span className="nav-link btn btn-gradient-primary btn-block active">EDIT CONTRACTOR</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="form-group">
