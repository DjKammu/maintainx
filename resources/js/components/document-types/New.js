...
function New(props) {
    ...
    useEffect(() => {
        document.title = 'New Document Type';
    ...
    const onSubmitHandle = (e) =>{
        ...
        if (simpleValidator.current.allValid()) {
            ...
            axios.post(
              '/api/v1/document-types',formData,{
              params: {
                                    ...
                                    <div className="form-group">
                                        <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                            <li className="nav-item">
                                                <span className="nav-link btn btn-gradient-primary btn-block active">NEW DOCUMENT TYPE</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="form-group">
